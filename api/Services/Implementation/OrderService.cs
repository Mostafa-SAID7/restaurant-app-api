...
public class OrderService : IOrderService
{
    ...
    /// <summary>
    /// Creates an order with proper transaction handling and EF-managed identity.
    /// Does NOT use GetNextMasterIdAsync - MasterID is auto-generated by the database.
    /// </summary>
    public async Task<OrderResponseDTO> CreateOrderAsync(int restaurantId, string apiKey, MenuDTO menuDTO)
    {
        // Validate input
